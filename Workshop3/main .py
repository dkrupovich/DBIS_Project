...
@app.route('/api/nutrition/submit', methods=['POST', 'GET'])
def nitrition_submit():
     global nutrition
     if request.method == "POST":
         nutrition["Title"] = request.form['title']
         nutrition["Brand"] = request.form['brand']
         nutrition["Ingredient"] = request.form['ingredient']
         nutrition["Weight"] = request.form['weight']
         nutrition["Price"] = request.form['price']
         nutrition["Short description"] = request.form['descr']
         return render_template("all.html", nutrition=nutrition_dictionary, customer=customer_dictionary)
     else:
         return render_template("nutrition.html", nutrition=nutrition_dictionary)


@app.route('/api/customer/submit', methods=['POST', 'GET'])
def customer_submit():
     global customer
     if request.method == "POST":
         ...
         customer["Adress"] = request.form['adress']
         return render_template("all.html", nutrition=nutrition_dictionary, customer=customer_dictionary)
     else:
         return render_template("customer.html", customer=customer_dictionary)
